      ...
      <div className="container px-4 md:px-6 py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <Image
              ...
              alt="Reach'd Marketing"
              width={300}
              height={120}
              className="h-24 w-auto mb-6 filter drop-shadow-lg"
            />
            <p className="text-gray-300 text-lg leading-relaxed mb-6 max-w-md">
              Powered by humans, fuelled by data. We turn $1 into $5 with ads that actually work. Join 500+ businesses
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span>hello@reachdmarketing.com</span>
              </div>
              <div className="flex items-center text-gray-300">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} Reach'd Marketing. All rights reserved.
          </p>
