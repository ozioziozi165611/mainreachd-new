...
const testimonials = [
  {
    ...
    quote:
      "Reach'd Marketing completely transformed our lead generation. In just 30 days, we went from struggling to get quality leads to having 79 genuine conversations with potential customers. The $6.80 cost per conversation is incredible - we were paying 3x that before!",
  ...
  },
  {
    ...
    quote:
      "I was skeptical about Facebook ads, but Reach'd proved me wrong. In just 11 days, we had 84 new conversations and booked out for the next month. The quality of leads is outstanding - these are people who actually want our services.",
