...
const testimonials = [
  {
    ...
    testimonial:
      "Working with Reach'd Marketing has been a game changer for us. In just 30 days, we had 79 genuine conversations start from their ads, all at an average cost of just $6.80. With only $537 spent, our reach exploded to over 22,000 people and nearly 38,000 impressions.",
    additionalQuote:
  ...
  },
  {
    ...
    testimonial:
      "Partnering with Reach'd Marketing has been one of the best decisions we've made. In just 30 days, we generated 183 messaging conversations through their campaigns at an average cost of only $6.07.",
    additionalQuote:
  ...
  },
  {
    ...
    testimonial:
      "We've only been running ads with Reach'd for 11 days, and results have blown us away. We've started 84 high conversion conversations from prospects at $2.64 each, off a total ad spend of $220.",
    additionalQuote:
