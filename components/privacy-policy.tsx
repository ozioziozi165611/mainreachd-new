          ...
          <Card className="bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8">
            <CardContent className="p-0 space-y-8">
              <div className="text-gray-300 leading-relaxed space-y-6">
                <p className="text-lg">
                  Reach'd Marketing ("we", "our", "us") respects your privacy and is committed to protecting your
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span>reachdmarketing@gmail.com</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <MapPin className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                      <span>2A Turner Avenue, Australia</span>
                    </div>
                  </div>
                </div>
              </div>
